...
public class GlobalConfig {
    ...
    private String restControllerName;
    /**
     * 指定生成的主键的ID类型
     */
    ...
    public String getRestControllerName() {
        return restControllerName;
    }

    public GlobalConfig setRestControllerName(String restControllerName) {
        this.restControllerName = restControllerName;
        return this;
    }
}
